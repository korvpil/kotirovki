...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StockType'
        db.create_table(u'apps_stocktype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'apps', ['StockType'])

        # Adding model 'StockCompany'
        db.create_table(u'apps_stockcompany', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'apps', ['StockCompany'])


    def backwards(self, orm):
        # Deleting model 'StockType'
        db.delete_table(u'apps_stocktype')

        # Deleting model 'StockCompany'
        db.delete_table(u'apps_stockcompany')
