...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HeaderMenu.description'
        db.add_column(u'apps_headermenu', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HeaderMenu.description'
        db.delete_column(u'apps_headermenu', 'description')
    ...
    models = {
        ...
        u'apps.passwordrestore': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['apps.User']"})
        },
        u'apps.user': {
