...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockCompany.stock_type'
        db.add_column(u'apps_stockcompany', 'stock_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apps.StockType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StockCompany.stock_type'
        db.delete_column(u'apps_stockcompany', 'stock_type_id')
